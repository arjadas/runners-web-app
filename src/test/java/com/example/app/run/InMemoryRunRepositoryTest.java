...
class InMemoryRunRepositoryTest {
    ...
    // nothing about spring is included here

    // need to set up beforehand because the postman construct won't run during tests
    @BeforeEach
    void setUp() {
    ...
    void shouldFindAllRuns() {
        ...
        assertEquals(2, runs.size(), "Should have returned 2 returns"); // message displayed if test fails
    }
