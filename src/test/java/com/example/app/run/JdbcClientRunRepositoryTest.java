...
// we didn't do @SpringBootTest because it'll load the entire application context which isn't require in jdbc testing
// would make our program slow if it was a huge application

@JdbcTest
@Import(JdbcClientRunRepository.class)  // @JdbcTest didn't import this class
...
class JdbcClientRunRepositoryTest {
    ...
    * usually used to inject external dependencies */
